    ...
    methods
        ...
        %   returns the preprocessed patterns in TRAINSET and TESTSET.
            ...
            if(exist([obj.directory '/' obj.train], 'file') && exist([obj.directory '/' obj.test], 'file'))
                ...
                %                      Add on TFG                      %
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                trainSet = TFGFileReadClass().ReadFile(obj.directory,obj.train,method.categ);
                testSet = TFGFileReadClass().ReadFile(obj.directory,obj.test,method.categ);
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
